"""
main.py
Prompt-matching engine for AI Orchestron.
...
app = FastAPI(title="AI Orchestron - Prompt Matching Engine")
...
prompt_embeddings = index_data["embeddings"]
...
def match_prompt(req: MatchRequest):
    query_vec = model.encode(req.user_prompt, normalize_embeddings=True)
